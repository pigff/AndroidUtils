 ...
 *     time  : 2016/9/27
 *     desc  : 清除相关工具类
 *  function : 1.清除内部缓存 cleanInternalCache2.清除内部文件 cleanInternalFiles3.清除内部数据库 cleanInternalDbs4.根据名称清除数据库 cleanInternalDbByName
 *             5.清除内部SP cleanInternalSP
 *             6.清除外部缓存 cleanExternalCache 7.清除自定义目录下的文件 cleanCustomCache
 * </pre>
 */
